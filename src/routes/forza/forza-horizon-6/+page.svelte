<script lang="ts">
  ...
  type ForzaTune = (typeof forzaHorizon6Tunes)[number];
  ...
  const data = $state(forzaHorizon6Tunes);
  ...
  const saveStatus = persistTableState("forza-horizon-6", table);
</script>

<h1 class="text-base-content mb-4 text-2xl font-bold">Forza Horizon 6 Tunes</h1>
